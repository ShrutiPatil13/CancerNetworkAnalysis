...
resolutions = ['resolution1', 'resolution09', 'resolution08', 'resolution05', 'resolution02', 'resolution01']  # Add more resolutions as needed
...
profile_rbc = optimiser.resolution_profile(ssn672, louvain.RBConfigurationVertexPartition,resolution_range=(0,1))
